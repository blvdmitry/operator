...
export type SingleChangeArgs = BaseChangeArgs & {
    value: number;
};
...
export type RangeProps = {
    ...
    maxAriaLabel: string;
    reversed?: never;
    renderValue?: ((minValue: number, maxValue: number) => React.ReactNode) | false;
...
export type SingleControlledProps = BaseProps & SingleProps & {
    range?: false;
    value: number;
    defaultValue?: never;
    minValue?: never;
...
export type SingleUncontrolledProps = BaseProps & SingleProps & {
    range?: false;
    value?: never;
    defaultValue?: number;
    minValue?: never;
...
export type RangeControlledProps = BaseProps & RangeProps & {
    range: true;
    value?: never;
    defaultValue?: never;
    minValue: number;
...
export type RangeUncontrolledProps = BaseProps & RangeProps & {
    range: true;
    value?: never;
    defaultValue?: never;
    minValue?: never;
...
export type UncontrolledProps = SingleUncontrolledProps | RangeUncontrolledProps;
