...
import type * as TBubbleContainer from "../BubbleContainer/BubbleContainer.types";
...
export type Item = (WithNotification | WithoutNotification) & (WithText | WithoutText) & (WithAvatar | WithIcon) & {
    id: Id;
...
export type Props = {
    items: Item[];
    selectedId?: Id;
    onItemChoose?: (item: Item, event: React.MouseEvent | React.KeyboardEvent) => void;
    className?: string;
