...
import type { DayNames, MonthNames, Week } from "@bookingcom/bui-core/utilities/date";
...
export type DayPublicProps = {
     ...
     * @deprecated use onMouseEnter prop instead
     * */
    onMouseIn?: () => void;
    onMouseEnter?: () => void;
    /**
     * TODO: remove in the next major release
     * @deprecated use onMouseLeave prop instead
     * */
    onMouseOut?: () => void;
    onMouseLeave?: () => void;
    onClick?: () => void;
...
export type MonthPrivateProps = Omit<MonthPublicProps, "firstWeekDay" | "dayNames" | "monthNames"> & {
    baseDate?: Date;
    focusedDateISO?: string | null;
...
export type BaseProps = {
    ...
    /**
     * TODO: remove in the next major release
     * @deprecated use onDayMouseEnter prop instead
     * */
    onDayHover?: (args: {
        date: Date;
    }) => void;
    onDayMouseEnter?: (args: {
        date: Date;
    }) => void;
    onDayMouseLeave?: (args: {
        date: Date;
    }) => void;
...
export type Props = Omit<ControlledProps | UncontrolledProps, "monthsToShow" | "vertical">;
