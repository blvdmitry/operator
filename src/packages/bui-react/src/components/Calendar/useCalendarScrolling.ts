...
const useCalendarScrolling = (props: Props) => {
  const {
    baseMonthDate,
    monthsToShow,
    elContentRef,
  ...
  React.useEffect(() => {
    ...
    if (!vertical || !elBaseMonth || !elContent) return;
