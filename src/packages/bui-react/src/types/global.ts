...
export type ChangeHandler<Value, Element = HTMLInputElement> = (
  args: ChangeArgs<Value, Element>
) => void;
...
export type StyleAttribute = React.CSSProperties &
...
export type Attributes<
  TagName extends keyof JSX.IntrinsicElements | void = void,
  OmittedProps = void,
  BaseAttributes = TagName extends keyof JSX.IntrinsicElements
    ? JSX.IntrinsicElements[TagName] & { ref?: any }
    : // TODO: Adding a more specific ref type breaks the build
      React.AllHTMLAttributes<HTMLElement> & { ref?: any }
> = Omit<
  BaseAttributes &
    DataAttributes & {
